...
<link rel="shortcut icon" href="assets/images/logo_header.png">
...
{ ?>
          <ul>
            ...
            <li>
              ...
              <div class="contact_info_m"><a href="tel:+998977477366"><?php   echo htmlentities($result->ContactNo); ?></a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="mailto:dream@team.com"><?php   echo htmlentities($result->EmailId); ?></a></div>
            </li>
          </ul>
        <?php }} ?>
        </div>
